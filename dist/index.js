...
const TextInputMask = forwardRef((_a, ref) => {
    ...
    return (<Input {...rest} ref={input} value={maskedValue} multiline={primaryFormat && Platform.OS === 'ios' ? false : multiline} onChangeText={(masked) => __awaiter(void 0, void 0, void 0, function* () {
        setMaskedValue(masked);
        if (primaryFormat) {
